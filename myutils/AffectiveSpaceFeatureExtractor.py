...
class AffectiveFeatureExtractor:
    def __init__(self,
                 affective_space_path="/hy-tmp/dataset/affectivespace/affective.csv"):
        """
    ...
    def _extract_concepts(self, text,top_k=5):
    ...
    def extract_features_batch(self, texts):
        ...
        for text in texts:
            ...
            all_affective_features.append(affective_features)


        return np.array(all_affective_features,dtype=np.float32)
